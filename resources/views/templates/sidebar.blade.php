...
<div class="sidebar" id="sidebar">
    ...
    <ul class="list-group">
        ...
        <a href="{{ url('d/add_panitia') }}"><li class="list-group-item"><i class="fa fa-fw fa-user-plus"></i> Add Panitia</li></a>
        @endif
    </ul>
    ...
    <ul class="list-group">
        @if(@$user->level == 1 || @$user->level == 2)
            ...
            <a href="{{ url('d/add_user') }}"><li class="list-group-item"><i class="fa fa-fw fa-user-plus"></i> Registrasi Peserta</li></a>
        @endif
